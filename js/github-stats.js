  ...
  function render(data) {
    ...
    document.getElementById("gs-kpi-row").innerHTML = `
      ...
      <div class="gs-kpi">
        ...
        <div class="gs-kpi__label">Views (14d)</div>
        <div class="gs-kpi__sub">${uniqueVisitors.toLocaleString()} unique</div>
      </div>
      <div class="gs-kpi">
        <div class="gs-kpi__value">${totalClones.toLocaleString()}</div>
        <div class="gs-kpi__label">Clones (14d)</div>
        <div class="gs-kpi__sub">${uniqueCloners.toLocaleString()} unique</div>
      </div>
    `;
      ...
      return `
        <div class="gs-card">
          ...
          <div class="gs-card__stats">
            ...
            <span class="gs-card__stat">${ICON_EYE} ${r.views_14d ?? 0}</span>
            <span class="gs-card__stat">${ICON_CLONE} ${r.clones_14d ?? 0}</span>
          </div>
        </div>
      `;
    }).join("");
